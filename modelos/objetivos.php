...
class ModeloObjetivos
{
    ...
    {
        $registro = Conexion::conectar()->prepare("INSERT INTO $tabla (nombre, localidad, referente, tipo) 
            VALUES (:nombre, :localidad, :referente, :tipo)");
    ...
    static public function mdlModificarObjetivo($tabla, $datos)
    {
        try {
            ...
            $sql = "UPDATE $tabla SET nombre = :nombre, localidad = :localidad, 
                    referente = :referente, tipo = :tipo WHERE idObjetivo = :idObjetivo";
