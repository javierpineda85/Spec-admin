...
// Cargar roles activos desde la BD
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="form-group col-sm-12 col-md-3">
            ...
            <div class="input-group">
              <div class="custom-file">
                <input type="file" class="custom-file-input" id="inputGroupFile01" name="imgPerfil" accept=".png,.jpg,.jpeg">
          ...
          <div class="form-group col-sm-12 col-md-3">
            ...
            <div class="input-group">
              <div class="custom-file">
                <input type="file" class="custom-file-input" id="inputGroupFile02" name="imgRepriv" accept=".png,.jpg,.jpeg">
